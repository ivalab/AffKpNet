...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--pull-weight', type=float, default=1,
                                 help='loss weight for pull embedding.')
        parser.add_argument('--push-weight', type=float, default=1,
                                 help='loss weight for push embedding.')
        parser.add_argument('--regr-weight', type=float, default=1,
                                 help='loss weight for offset regression.')
        parser.add_argument('--seg-weight', type=float, default=100,
                                 help='loss weight for offset regression.')
        # optimizer params
