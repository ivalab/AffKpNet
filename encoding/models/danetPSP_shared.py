...
class DANetHead(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer):
        ...
        self.conv1x1 = nn.Sequential(nn.Dropout2d(0.1, False), nn.Conv2d(512, 128, 1))

        self.avepool2x2 = nn.AvgPool2d(5, 5)
        self.conv2x2 = nn.Sequential(nn.Dropout2d(0.1, False), nn.Conv2d(512, 128, 1))

        self.avepool3x3 = nn.AvgPool2d(3, 3)
        self.conv3x3 = nn.Sequential(nn.Dropout2d(0.1, False), nn.Conv2d(512, 128, 1))

        self.avepool6x6 = nn.AvgPool2d(2, 2)
        self.conv6x6 = nn.Sequential(nn.Dropout2d(0.1, False), nn.Conv2d(512, 128, 1))

        self.interp = nn.Upsample(size=(60, 60), mode='bilinear')
        self.conv512 = nn.Sequential(nn.Dropout2d(0.1, False), nn.Conv2d(1024, 512, 1))
